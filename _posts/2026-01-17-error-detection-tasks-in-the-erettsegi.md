---
layout: post
title: How Can You Ace Error Detection Tasks?
published: true
tags: ESL learning
image: cat-and-another-cat.png
language: en
...
Not only do they feel like you might be feeling right now: clueless and like it is a shot in the dark, blindly guessing what word could be the odd one out, but there is also little help online in this, and teachers often just shrug it off saying “yeah, this is not good there because it doesn’t fit in the sentence”. Of course, as with all érettségi tasks, practice makes perfect; and after doing 10-20 sets of these tasks (you can find them all [listed out here](/erettsegi/search?type=uoe-error-correction)), you will be able to make intelligent guesses and start to develop an intuitive sense about what could be wrong and what to be looking out for.
...
* [Error detection tasks and spot-the-difference puzzles](#error-detection-tasks-and-spot-the-difference-puzzles)
* [Cat-and-dog errors: the easy kind](#cat-and-dog-errors-the-easy-kind)
* [The cat-and-another-cat type](#the-cat-and-another-cat-type)
* [Distribution of error types in error detection tasks](#distribution-of-error-types-in-error-detection-tasks)
...
![An example for the cat-and-dog kind of spot-the-difference task."](/assets/cat-and-dog.png "An example for the cat-and-dog kind of spot-the-difference task.")
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “whose father had been <span class="text-unit strikethrough" markdown="1">a</span> responsible for establishing the Abbey.” 
</div>
</div>
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “nerdy and boring. However, the 61-year-old enthusiast <span class="text-unit strikethrough" markdown="1">did</span> hoped”
</div>
</div>
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “The 2014 calendar <span class="text-unit strikethrough" markdown="1">had</span> features 12 months of run-down phone [boxes]” 
</div>
</div>
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “all – through the <span class="text-unit strikethrough" markdown="1">most</span> simplest day-to-day occurrences. Sunshine” 
</div>
</div>
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “[the type of] jet-lag people refer to when <span class="text-unit strikethrough" markdown="1">they</span> talking about fatigue after a long” 
</div>
</div>
May 2007, Item 29
...
![An example for the cat-and-anothet-cat kind of spot-the-difference task."](/assets/cat-and-another-cat.png "An example for the cat-and-another-cat kind of spot-the-difference task.")
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “They kept on walking, until they <span class="text-unit strikethrough" markdown="1">have</span> found an oasis, where they” 
</div>
</div>
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “Everyone <span class="text-unit strikethrough" markdown="1">had</span> obeyed except a tailor called Tom. This curious” 
</div>
</div>
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “(...) For two years you've <span class="text-unit strikethrough" markdown="1">been</span> watered them” 
</div>
</div>
May 2012, Item 37
...
> fire service, so <span class="text-unit strikethrough" markdown="1">as</span> Merlin should be able to sleep at night. West”
</div>
</div>
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “Road was built around them. The family even <span class="text-unit strikethrough" markdown="1">though</span> have chickens living
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> ‘Their keen <span class="text-unit strikethrough" markdown="1">on</span> intellect and strong emotional bond made them “family \[members\]”’
</div>
</div>
...
<div class="uoe-error-correction task" markdown="1">
<div class="uoe-error-correction-line" markdown="1">
> “\[the seven-\]continent model has been a mistake <span class="text-unit strikethrough" markdown="1">for</span> all along. Enter Zealandia”
</div>
</div>
...
const pieChartData = [
  ...
  { label: 'Tell/say/reply/ask', value: 2.35, color: '#F9F871' },
  { label: 'Extra verb', value: 2.11, color: '#00C9A7' },
  { label: 'Extra "it"', value: 1.88, color: '#FF9671' },
  { label: 'Wrong phrasal verb', value: 1.41, color: '#A0C4FF' },
  { label: 'Misplaced intensifier', value: 1.17, color: '#B5838D' },
  { label: 'Other', value: 9.39, color: '#FFC75F' }
];
...
let slices = [];
let tooltipVisible = false; // Track if click tooltip is active
...
function drawPieChart() {
  ...
  pieChartData.forEach(item => {
    ...
    // Save slice info for interactions
    slices.push({
      startAngle,
...
function getSliceUnderCursor(x, y) {
  const dx = x - centerX;
  const dy = y - centerY;
  ...
  return slices.find(s => angle >= s.startAngle && angle <= s.endAngle);
}
...
canvas.addEventListener('mousemove', (evt) => {
  if (tooltipVisible) return; // Skip hover if click tooltip is active


  const pos = getMousePos(evt);
  const slice = getSliceUnderCursor(pos.x, pos.y);
...
canvas.addEventListener('mouseleave', () => {
  if (!tooltipVisible) tooltip.style.opacity = 0;
});
...
> Dad bursting through the front door <span class="text-unit strikethrough" markdown="1">was</span> waving a book, shouting
